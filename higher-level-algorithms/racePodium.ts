 ...
 * Ordered top three.
 */
export function racePodium(runRace: (...participants: RaceParticipants) => RaceParticipants): [number, number, number] {
  ...
  raceResults.push(
    runRace(raceResults[0][0], raceResults[1][0], raceResults[2][0], raceResults[3][0], raceResults[4][0])
  );
